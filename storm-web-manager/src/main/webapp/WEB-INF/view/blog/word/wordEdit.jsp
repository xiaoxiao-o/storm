		...
		<form class="layui-form layui-form-pane">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="title" value="${word.title }" lay-verify="title"
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea name="word" placeholder="请输入内容" class="layui-textarea" lay-verify="word">${word.word }</textarea>
				</div>
			</div>
			<div class="layui-form-item">
        ...
        form.on('submit(form)', function(data) {
            $.ajax({
                ...
                success:function(data){
                    if(data.code==200){
                        layer.alert("修改标签成功",{shade: 0,icon:1},function(index){
                            parent.layer.closeAll();	//关闭所有
                        });
                    }else{
                        layer.alert("修改标签失败",{icon:2});
                    }
                }
            });
            return false;
