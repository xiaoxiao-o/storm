	...
	<div class="main-content">
		<form class="layui-form layui-form-pane">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="artist" lay-verify="artist"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="cover" lay-verify="cover"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="source" lay-verify="source"
						   autocomplete="off" placeholder="请输入资源地址" class="layui-input" value="http://music.163.com/song/media/outer/url?id=.mp3">
				</div>
			</div>
			<div class="layui-form-item">
		...
		form.on('submit(form)', function(data) {
			$.ajax({
				...
				success:function(data){
					if(data.code==200){
						layer.alert("新增音乐成功",{shade: 0,icon:1},function(index){
							parent.layer.closeAll();	//关闭所有
						});
					}else{
						layer.alert("新增音乐失败",{icon:2});
					}
				}
			});
			return false;
