		...
		<div class="layui-form layui-form-pane" id="condition">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<button class="layui-btn" id="add"><i class="layui-icon layui-icon-add-1"></i>新建音乐</button>
				</div>
			</div>
		</div>

		<table class="layui-hide" id="music-table" lay-filter="music-table"></table>
		<!-- 右侧工具栏 -->
	...
	layui.use(['table','form'], function() {
		...
		table.render({
			...
			cols : [ [ 
				...
				{field : 'title',title : '音乐名称',align : 'center'},
				{field : 'artist',title : '作者',align : 'center'},
                {field : 'cover',title : '封面',align : 'center'},
                {field : 'source',title : '资源',align : 'center'},
        ...
        function search(){
            ...
            //执行重载
            table.reload('music-table-reload', {
                page : {
                    curr : 1
                },
                where : {
